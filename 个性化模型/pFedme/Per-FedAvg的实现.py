...
task = './my_task1'
flgo.gen_task_by_(mnist, fbp.IIDPartitioner(num_clients=2), task)
runner = flgo.init(task, pfedme, option={'num_rounds':4, 'local_test':True, 'learning_rate':0.005, }, Logger=PFLLogger)
runner.run()
analysis_plan = {
    'Selector':{
        'task': task,
